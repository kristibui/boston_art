...
(at the edge of the Boston Common), depicting Col. Shaw and the 54th Regiment Massachusetts Volunteer
 ...
 It has been acclaimed as the greatest American sculpture of the 19th century. ', 1,  2, 'Shaw Memorial',  'http://oi65.tinypic.com/vql5e0.jpg'),
...
He came to the U.S. in 1948 via the U.S. Committee for Orphaned Children, went to college,
 ...
 The monument invites you to walk along a path among and into the towers.', 2, 4, 'New England Holocaust Memorial', 'http://i64.tinypic.com/2ed8mfs.jpg'),
...
Urban planner Suzanne DeMonchaux thought it would make a great public sculpture for Boston — modeling how cities can be more friendly to children.', 3, 1, 'Make Way for Ducklings', 'http://i66.tinypic.com/288xirm.jpg'),
...
One of the rare places in the region where graffiti can be done legally. ', 4, 3, 'Graffiti Wall', 'http://i66.tinypic.com/2my3myq.jpg'), 
...
She’d send them to the reporters who wrote the articles and ask them to pass the buttons along to the families.', 5, 1, 'Memorial Buttons', 'http://i63.tinypic.com/qy8gp1.jpg'),
...
hotels and retail space on the three-acre property, which has been home to mini golf since 1958, and adjoining land.', 6, 2, 'Orange Dinosaur', 'http://i64.tinypic.com/2kkbqe.jpg'),
...
which arose out of late 1960s activism to prevent the displacement of the neighborhood’s residents.', 7, 3, 'Betances Mural', 'http://i63.tinypic.com/508i8.jpg'),
...
So the back of the boats got their first giant swans, which have become one of the icons of Boston.', 8, 1, 'Swan Boats', 'http://i65.tinypic.com/11h5chu.jpg'), 
...
but also because it invites acts of psychogeography, exploring the landscape by engaging with its psychological history.', 9, 4, 'Freedom Trail', 'http://i65.tinypic.com/2ihmgr8.jpg'),
...
with its echo of Malden-native Frank Stella’s 1960s geometric abstractions — dates to a rebranding in 1965.',10, 4, 'Citgo Sign', 'http://i63.tinypic.com/cnqqa.jpg'),
...
monumental reflecting pool, 690 feet long, 100 feet wide, running parallel to Huntington Avenue.', 11, 4, 'Reflecting Pool', 'http://i63.tinypic.com/11j0hzs.jpg'), 
...
she was protesting the Vietnam War, but Kent herself always denied embedding such a profile.', 12, 4, 'Rainbow Swash', 'http://i64.tinypic.com/214tqid.jpg'),
...
operating again as a snack stand, delighting children and becoming a local icon.', 13, 4, 'Giant Milk Bottle', 'http://i64.tinypic.com/db5z5.jpg'),
...
seemingly heavy is so carefully balanced that it spins so gracefully in the breeze.', 14, 4, 'Gift of the Wind', 'http://i63.tinypic.com/24eufcz.jpg'),
...
and symbolic of the nation’s neoclassical, republican ideals — was completed.', 15, 4, 'Bunker Hill Monument', 'http://i66.tinypic.com/2vjeusz.jpg'),
...
designed a monumental statue of Mary, the mother of Jesus, that was erected at the order’s center there in 1953.', 16, 3, 'Madonna Queen of the Universe Shrine', 'http://i67.tinypic.com/2njinib.jpg'),
...
except it had two backs bending up to meet each other. The surreal change prompted double-takes.', 17, 1, 'Jamaica Pond Bench', 'http://i63.tinypic.com/v4w2l1.jpg'), 
...
Now it’s becoming an advertising landmark — big, yellow and fun.', 18, 2, 'Tessie the Giraffe', 'http://i63.tinypic.com/34zx34g.jpg'),
...
monarch butterfly and blue jay (“a resident of Jamaica Plain, a sort of spirit animal”).', 19, 4, 'Nieli\'ka', 'http://i66.tinypic.com/20koayh.jpg'), 
...
They seem to fly across the expanse of the wall like superheroes.', 20, 4, 'Taino Indians', 'http://i64.tinypic.com/2cqg0td.jpg'),
...
Nelson Mandela, 
South Africa’s anti-segregation and anti-apartheid leader who died in 2013, flanked by the slogan “Roxbury love.”', 21, 4, 'Roxbury Love "Mandela"', 'http://i68.tinypic.com/jifdpf.jpg'),
...
This ball machine was designed by George Rhoads in collaboration with Rock Stream Studios.', 22, 3, 'Archimedean Excogitation', 'http://i68.tinypic.com/295vour.jpg'),
...
over a steel frame — went on display inside the museum in 1972.', 23, 4, 'Tyrannosaurus Rex', 'http://i65.tinypic.com/14mvz0y.jpg'),
...
used the violence to rally people to their cause.', 24, 2, 'Site of the Boston Massacre', 'http://i66.tinypic.com/2wovkwn.jpg'),
...
After succumbing to weather and use, it was restored to musicality in 2013.', 25, 3, 'Charlestown Bells', 'http://i67.tinypic.com/fwmy4k.jpg'),
...
“to restore women to their rightful place in the history of Boston.” ', 26, 1, 'Phillis Wheatley Plaque', 'http://i64.tinypic.com/kcdy14.jpg'),
...
women in the state of Hidalgo in central Mexico. … Then the cloths are used as hangings.”', 27, 3, 'Tenango', 'http://i67.tinypic.com/2iqlf6u.jpg'),
...
he painstakingly depicted the Bochs in somewhat-larger-than-life fiberglass over an aluminum frame.', 28, 2, 'Super Saver', 'http://i66.tinypic.com/30xk6te.jpg'),
...
with flowers hanging down from a window box above as hair. It all hints at the mysteries inside.', 29, 3, 'Mural façade of the Museum of Modern Renaissance', 'http://i64.tinypic.com/2namds8.jpg'),
...
And the model for the goddess was the El Mac’s own wife, Kim.', 30, 4, 'Ars et Scienta', 'http://i67.tinypic.com/t8ri1y.jpg'),
...
a Wampanoag turtle, an Indian peacock, and classic New England ship and mermaid tattoo designs.', 31, 4, 'Connected by Sea', 'http://i63.tinypic.com/w7yo2q.jpg');
